# Generated by Django 2.2.19 on 2022-11-24 19:33
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('ingredients', models.ManyToManyField(related_name='recipes', to='recipes.IngredientInRecipe', verbose_name='Список ингредиентов')),
            ],
            options={
                'verbose_name': 'Рецепт',
        ...
        migrations.AddField(
            model_name='recipe',
            name='tags',
            field=models.ManyToManyField(related_name='tag', to='recipes.Tag', verbose_name='Список тегов'),
        ),
        migrations.CreateModel(
            name='Favorite',
            fields=[
